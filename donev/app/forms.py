...
from django.contrib.auth.forms import UserCreationForm,AuthenticationForm,UsernameField,d,PasswordChangeForm,PasswordResetForm,SetPasswordForm
...
class MyPasswordChangeForm(PasswordChangeForm):
    old_password=forms.CharField(label="Old Password",strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'current-password',
    'autofocus':True,'class':'form-control','placeholder':'Old Password'}))
    new_password1=forms.CharField(label="New Password",strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'new-password',
    'autofocus':True,'class':'form-control','placeholder':'Old Password'}))
    ...
    'autofocus':True,'class':'form-control','placeholder':'Confirm Password'}))
...
class DonateNowForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels={
            "donationpic":"Donation Images(Pic of Items u want to donate)",
